...
public class FontRenderer implements Closeable , IMinecraftClient {
    ...
    public void drawString(MatrixStack stack, String s, float x, float y, float r, float g, float b, float a, Color gradientColor, int offset) {
        ...
        synchronized (GLYPH_PAGE_CACHE) {
            for (int i = 0; i < chars.length; i++) {
                ...
                r2 = gradientColor.getRed() / 255f;
                g2 = gradientColor.getGreen() / 255f;
                b2 = gradientColor.getBlue() / 255f;
                a = gradientColor.getAlpha() / 255f;
    ...
    public void drawString(MatrixStack stack, String s, float x, float y, float r, float g, float b, float a, int offset) {
        if (prebakeGlyphsFuture != null && !prebakeGlyphsFuture.isDone()) {
            try {
                prebakeGlyphsFuture.get();
            } catch (InterruptedException | ExecutionException ignored) {
    ...
    public void drawGradientString(MatrixStack stack, String s, float x, float y,Color color1,Color color2, int offset) {
        drawString(stack, s, x, y, color1.getRed(), color1.getGreen(), color1.getBlue(), color1.getAlpha(), color2, offset);
    }

    public void drawGradientCenteredString(MatrixStack matrices, String s, float x, float y,Color color1,Color color2, int offset) {
